      ...
      <tabs fill class="flex-column flex-md-row">
        <card shadow>
          <tab-pane title="지역 검색">
            <p class="description">
              <!-- <b-col class="sm-3" style="margin: 10px">
                <b-form-select
                  v-model="sidoCode"
                  :options="sidos"
                  @change="gugunList"
              ...
              <b-form inline style="margin: 10px; align: center">
                <b-form-select
                  v-model="sidoCode"
                  :options="sidos"
                  @change="gugunList"
          ...
          <tab-pane title="아파트 검색">
            <p class="description" style="margin: 20px">
              <b-form-input
                v-model="aptName"
                placeholder="Enter Apt name"
              ></b-form-input>
            </p>
            <p class="description">
              <base-button
